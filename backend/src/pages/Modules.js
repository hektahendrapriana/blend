...
function Modules() {
    ...
    const getDataList = async () => {
        await Api().get(`pages?filter=${keyword}&fields=name,path,method,source&page=${page}&limit=${limit}`)
                    ...
                    <div className="content-header">
                        <Container fluid>
                            <Row className="">
                                ...
                                <Col sm={2}>
                                    { checkMenu('addmodule') &&
                                        <Link to="addmodule"><Button variant="outline-primary" className="btn-upload"><AiOutlinePlus /> Add Module</Button></Link>
                                    }
                                </Col>
                                <Col sm={3}>
                                    ...
                                    <Table striped hover responsive>
                                        <thead className='thead'>
                                            <tr>
                                                ...
                                                <th className="col-username">Path</th>
                                                <th className="col-username">Method</th>
                                                <th className="col-username">Source</th>
                                        ...
                                        <tbody>
                                            {
                                                dataList.map((item, i) => (
                                                    <tr key={i}>
                                                        ...
                                                        <td>{item.name}</td>
                                                        <td>{item.path}</td>
                                                        <td className="project_progress">{item.method}</td>
                                                        <td className="project_progress">{item.source}</td>
